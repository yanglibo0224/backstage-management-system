...
import styles from '../../questions/addques/index.scss';
...
function Addques(props) {
  useEffect(() => {
    ...
    props.getQuestion({questions_id:`${props.location.search.split('=')[1]}`});
        ...
        <div className={styles.markcont}>
          ...
          <Form.Item>
            {getFieldDecorator('title', {
              ...
              initialValue: props.exam.getQuestionsData[0].title
            })(
          ...
          <Form.Item>
            {getFieldDecorator('questions_stem', {
              initialValue:  props.exam.getQuestionsData[0].questions_stem
            })(
              <Editor />
              )}
          </Form.Item>
        ...
        <div>
          ...
          <Form.Item>
            {getFieldDecorator('exam_id', {
              rules: [{ required: true, message: '请输入题目标题!' }],
              initialValue:  props.exam.getQuestionsData[0].exam_id
            })(
        ...
        <div>
          ...
          <Form.Item>
            {getFieldDecorator('subject_id', {
              rules: [{ required: true, message: '请输入题目标题!' }],
              initialValue: props.exam.getQuestionsData[0].subject_id
            })(
              <Select style={{ width: 160 }}>
                {
        ...
        <div>
          ...
          <Form.Item>
            {getFieldDecorator('questions_type_id', {
              rules: [{ required: true, message: '请输入题目标题!' }],
              initialValue: props.exam.getQuestionsData[0].questions_type_id
            })(
              <Select style={{ width: 160 }}>
                {
        ...
        <div className={styles.markcont}>
          ...
          <Form.Item>
            {getFieldDecorator('questions_answer', {
              initialValue: props.exam.getQuestionsData[0].questions_answer
            })(
              <Editor />
              )}
          </Form.Item>
